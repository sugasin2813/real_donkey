...
STEERING_LEFT_PWM = 452         #pwm value for full left steering
STEERING_RIGHT_PWM = 272        #pwm value for full right steering
THROTTLE_CHANNEL = 1            #(deprecated) channel on the 9685 pwm board 0-15
THROTTLE_FORWARD_PWM = 483      #pwm value for max forward throttle
THROTTLE_STOPPED_PWM = 373      #pwm value for no movement
THROTTLE_REVERSE_PWM = 262      #pwm value for max reverse throttle
...
CONTROLLER_TYPE = 'rc3'            #(ps3|ps4|xbox|pigpio_rc|nimbus|wiiu|F710|rc3|MM1|custom) custom will run the my_joystick.py controller written by the `donkey createjs` command
...
# STEERING_PWM_FREQ = 10          #Frequency for PWM
